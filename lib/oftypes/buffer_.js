 ...
 */
export default async function buffer_( variable, resolvers = { true: true, false: false }, payback = false ) {

    return resolves( { name: 'buffer_', reference: 'Buffer' }, { variable:variable, resolvers:resolvers, payback: payback } )
}
