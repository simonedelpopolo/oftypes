...
import { buffer_, null_, object_, promise_, undefined_ } from '../../index.js'

const function_Symbol = Symbol( 'Object [ oftypes.function_ ]' )
const function_ = Object.defineProperty( oftypes, function_Symbol, {
    enumerable: true,
    writable: false,
    configurable: false,
