 ...
 */
export default async function array_( variable, resolvers = { true: true, false: false }, payback = false ) {

    return resolves( { name: 'array_', reference: 'Array' }, { variable:variable, resolvers:resolvers, payback: payback } )
}
