 ...
 */
export default async function nan_( variable, resolvers = { true: true, false: false }, payback = false ){

    const rejection = await rejects( 'nan_', { resolvers: resolvers, payback: payback, strict: false, string: undefined } )
