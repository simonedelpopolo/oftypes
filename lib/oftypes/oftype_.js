...
export const oftype_Symbol = Symbol( 'Object [ oftypes.oftype_ ] typeof enhanced' )
export const oftype_ = Object.defineProperty( oftypes, oftype_Symbol, {
    enumerable: true,
    writable: false,
    configurable: false,
    ...
    value: async function oftype_( variable, resolvers= undefined, payback = false ){
        ...
        const types_ = types( resolvers, payback )
        if ( types_ !== true )
            return error( types_ )
