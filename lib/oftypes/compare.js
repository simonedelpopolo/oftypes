...
export const compare_Symbol = Symbol.for( 'Object [ oftypes.compare ]' )
const compare = Object.defineProperty( oftypes[ Symbol.for( 'oftypes' ) ], compare_Symbol, {
    enumerable: true,
    writable: false,
    configurable: false,
     ...
     */
    value: function compare( v_1, v_2, strict = false, resolvers = { true: true, false: false }, payback = false ) {

        return new Promise( ( resolve ) => {

            let truthy = false

            reject( 'compare', { payback:payback, strict: strict, resolvers: resolvers, string: undefined } )
