 ...
 */
export default async function compare( v_1, v_2, strict = false, resolvers = { true: true, false: false }, payback = false ) {

    let truthy = false
    const rejection = await rejects( 'compare', { payback:payback, strict: strict, resolvers: resolvers, string: undefined } )
