 ...
 */
export default async function undefined_( variable, resolvers = { true: true, false: false }, payback = false ) {

    const rejection = await rejects( 'undefined_', { payback:payback, strict: false, resolvers: resolvers, string: undefined } )
