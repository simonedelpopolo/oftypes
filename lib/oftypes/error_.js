 ...
 */
export default async function error_( variable, resolvers = { true: true, false: false }, payback = false ) {

    const rejection = await rejects( 'error_', { resolvers: resolvers, payback: payback, strict: false, string: undefined } )
